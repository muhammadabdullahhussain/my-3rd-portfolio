...
const projectsList = [
  ...
  {
    id: 11,
    title: "FitQuest — Health Tracker",
    category: "mobile",
    description:
      "A comprehensive fitness application for tracking workouts, nutrition, and daily activity with personalized goals.",
    longDesc:
      "FitQuest helps users stay on top of their health with an intuitive interface for logging exercises, tracking calorie intake, and monitoring progress over time with dynamic charts.",
  ...
  },
  {
    ...
    category: "mobile",
    description:
      "Real-time food delivery platform connecting local restaurants with customers via a seamless ordering experience.",
    longDesc:
      "FoodieGo provides a premium food ordering experience with live order tracking, secure payment integration, and a sophisticated recommendation engine for personalized dining.",
  ...
  },
  {
    ...
    category: "mobile",
    description:
      "Secure cryptocurrency wallet and portfolio manager for tracking digital assets and performing instant swaps.",
    longDesc:
      "CryptoVault offers a high-security environment for managing Bitcoin, Ethereum, and other digital assets with real-time price alerts and built-in decentralized exchanges.",
    img: "/apps screenshots/original-5a0621b7a943fc636554615a823aa49d.webp",
    tech: ["React Native", "Web3.js", "Solidity", "TailwindCSS"],
    liveUrl: "#",
    githubUrl: "#",
    featured: true,
    color: "#fbbf24",
  ...
  {
    id: 14,
    title: "EduStream — Learn Online",
    category: "mobile",
    description:
      "Interactive learning platform with video courses, live quizzes, and peer-to-peer discussion forums.",
    longDesc:
      "EduStream democratizes education by offering high-quality video courses with offline playback, progress tracking, and professional certifications upon completion.",
    img: "/apps screenshots/original-ac3dbbf377894c99a2f38962bf293856.webp",
    tech: ["React Native", "AWS Amplify", "GraphQL", "Video.js"],
    liveUrl: "#",
    githubUrl: "#",
    featured: false,
    color: "#60a5fa",
  ...
  {
    id: 15,
    title: "MediCare — Health Consult",
    category: "mobile",
    description:
      "Telemedicine app connecting patients with certified doctors for video consultations and digital prescriptions.",
    longDesc:
      "MediCare simplifies healthcare by providing instant access to specialists, secure medical record storage, and automated pill reminders for patients.",
    img: "/apps screenshots/original-f14b1f6910cab67c2565d9a97004bfcd.webp",
    tech: ["React Native", "WebRTC", "Express.js", "PostgreSQL"],
    liveUrl: "#",
    githubUrl: "#",
    featured: false,
    color: "#f472b6",
  ...
  {
    id: 16,
    title: "TravelWise — Planner",
    category: "mobile",
    description:
      "All-in-one travel companion for booking flights, hotels, and discovering hidden gems around the world.",
    longDesc:
      "TravelWise takes the stress out of trip planning with AI-powered itineraries, collaborative group planning, and real-time flight status updates.",
    img: "/apps screenshots/original-f61ad4c1ae2a222cdd4da78082ff7a7b.webp",
    tech: ["React Native", "Amadeus API", "Framer Motion", "Redux"],
    liveUrl: "#",
    githubUrl: "#",
    featured: false,
    color: "#818cf8",
